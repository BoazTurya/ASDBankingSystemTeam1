...
public class JDialog_Withdraw extends JDialog {
    ...
    public JDialog_Withdraw(BankFrm parent, String aaccnr, BankAccountService accountService) {
        super(parent);
        parentframe = parent;
        accnr = aaccnr;
    ...
    void JButtonOK_actionPerformed(java.awt.event.ActionEvent event) {
        this.accountService.withdraw(accnr, Double.parseDouble(JTextField_AMT.getText()));
