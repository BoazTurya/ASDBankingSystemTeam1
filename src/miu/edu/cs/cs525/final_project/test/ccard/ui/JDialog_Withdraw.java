...
public class JDialog_Withdraw extends javax.swing.JDialog {
    ...
    public JDialog_Withdraw(CardFrm parent, String creditCardNumber, CardAccountService accountService) {
        super(parent);
        parentframe = parent;
        ...
        JTextField_NAME.setText(creditCardNumber);
    ...
    void JButtonOK_actionPerformed(java.awt.event.ActionEvent event) {
        this.accountService.charge(creditCardNumber,Double.parseDouble(JTextField_AMT.getText()));
