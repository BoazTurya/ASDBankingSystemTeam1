...
public class JDialog_GenerateReport extends JDialog
{
	...
	public JDialog_GenerateReport(Frame parent, String creditCardNumber , CardAccountService accountService)
	{
		super(parent);
		...
		Account account = accountService.getAccount(creditCardNumber);
		billstring = accountService.generateReport(creditCardNumber).getReport();
