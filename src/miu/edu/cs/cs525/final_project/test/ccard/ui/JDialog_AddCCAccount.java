...
import miu.edu.cs.cs525.final_project.test.ccard.CardAccount;
import miu.edu.cs.cs525.final_project.test.ccard.CardAccountService;
...
public class JDialog_AddCCAccount extends JDialog {
    ...
    private CardAccountService customerService;

    public JDialog_AddCCAccount(CardFrm parent, CardAccountService customerService) {
        super(parent);
        parentframe = parent;
    ...
    void JButtonOK_actionPerformed(java.awt.event.ActionEvent event) {
        // Set default to gold account factory
        String type = "gold";
        if (JRadioButton_Silver.isSelected())
           type = "silver";
        if(JRadioButton_Bronze.isSelected())
            type = "bronze";
        customerService.createPersonalAccount(JTextField_CCNR.getText(),JTextField_NAME.getText(),JTextField_Email.getText(),JTextField_STR.getText(),JTextField_CT.getText(),JTextField_ST.getText(),JTextField_ZIP.getText(),LocalDate.now(),type,LocalDate.now());
