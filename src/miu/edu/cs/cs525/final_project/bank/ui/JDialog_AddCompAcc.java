...
public class JDialog_AddCompAcc extends JDialog {
    ...
    public JDialog_AddCompAcc(BankFrm parent, BankAccountService accountService) {
        super(parent);
        parentframe = parent;
...
//        CompanyAccountDto customer = new CompanyAccountDto(new Random(1000).nextInt() + "", JTextField_NAME.getText(), "test@gmail.com", address, Integer.parseInt(JTextField_NoOfEmp.getText()));
        if (JRadioButton_Chk.isSelected())
            type = "checking";
//        AccountDto accountDto = new AccountDto(JTextField_ACNR.getText(), type);
        accountService.createOrganizationAccount(JTextField_ACNR.getText(),JTextField_NAME.getText(),JTextField_EM.getText(),JTextField_STR.getText(),JTextField_CT.getText(),JTextField_ST.getText(),JTextField_ZIP.getText(), Integer.parseInt(JTextField_NoOfEmp.getText()),type);
