...
public class JDialog_AddPAcc extends JDialog {
    ...
    public JDialog_AddPAcc(BankFrm parent, BankAccountService customerService) {
        super(parent);
        parentframe = parent;
...
//        PersonalAccountDto personalAccountDto = new PersonalAccountDto(new Random(100).nextInt() + "", JTextField_NAME.getText(), "", address, LocalDate.now());
        if (JRadioButton_Chk.isSelected())
            type = "checking";
//        AccountDto accountDto = new AccountDto(JTextField_ACNR.getText(), type);
        customerService.createPersonalAccount(JTextField_ACNR.getText(),JTextField_NAME.getText(),JTextField_EM.getText(),JTextField_STR.getText(),JTextField_CT.getText(),JTextField_ST.getText(),JTextField_ZIP.getText(),LocalDate.now(),type);
